...
namespace aik099\QATools\BEM\PropertyDecorators;


use aik099\QATools\BEM\Annotations\BEMAnnotation;
...
class BEMPropertyDecorator extends DefaultPropertyDecorator
{
	...
	{
		return $this->classMatches($property->getDataType(), '\\aik099\\QATools\\BEM\\Elements\\Block');
	}
	...
	{
		return $this->classMatches($property->getDataType(), '\\aik099\\QATools\\BEM\\Elements\\Element');
	}
