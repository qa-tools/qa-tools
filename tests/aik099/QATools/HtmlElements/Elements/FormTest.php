...
use aik099\QATools\HtmlElements\Elements\Form;
use Mockery as m;

class FormTest extends HtmlElementTest
{

	const TYPIFIED_ELEMENT_CLASS = '\\aik099\\QATools\\HtmlElements\\Elements\\TypifiedElement';
	...
	protected function setUp()
	{
		if ( is_null($this->elementClass) ) {
			$this->elementClass = '\\aik099\\QATools\\HtmlElements\\Elements\\Form';
		}
	...
	{
		return array(
			array('input', 'checkbox', '\\aik099\\QATools\\HtmlElements\\Elements\\Checkbox'),
			array('input', 'radio', '\\aik099\\QATools\\HtmlElements\\Elements\\RadioGroup'),
			array('input', 'file', '\\aik099\\QATools\\HtmlElements\\Elements\\FileInput'),
			array('input', null, '\\aik099\\QATools\\HtmlElements\\Elements\\TextInput'),
			array('input', 'text', '\\aik099\\QATools\\HtmlElements\\Elements\\TextInput'),
			array('input', 'password', '\\aik099\\QATools\\HtmlElements\\Elements\\TextInput'),
			array('input', 'color', '\\aik099\\QATools\\HtmlElements\\Elements\\TextInput'),
			array('select', null, '\\aik099\\QATools\\HtmlElements\\Elements\\Select'),
			array('textarea', null, '\\aik099\\QATools\\HtmlElements\\Elements\\TextInput'),
		);
	}
	...
	public function testSetValueSuccess()
	{
		$mock_parts = array(
			...
			'\\aik099\\QATools\\HtmlElements\\Elements\\ISimpleSetter',
		);
