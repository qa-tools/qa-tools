...
use Mockery as m;
use aik099\QATools\HtmlElements\Elements\Radio;
use aik099\QATools\HtmlElements\Elements\RadioGroup;

class RadioGroupTest extends TypifiedElementTest
{

	const RADIO_CLASS = '\\aik099\\QATools\\HtmlElements\\Elements\\Radio';
	...
	protected function setUp()
	{
		if ( is_null($this->elementClass) ) {
			$this->elementClass = '\\aik099\\QATools\\HtmlElements\\Elements\\RadioGroup';
		}
