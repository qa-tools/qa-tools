...
class TypifiedElementTest extends TestCase
{
	...
	const WEB_ELEMENT_CLASS = '\\aik099\\QATools\\PageObject\\Elements\\WebElement';
	...
	protected function setUp()
	{
		...
		if ( is_null($this->elementClass) ) {
			$this->elementClass = '\\tests\\aik099\\QATools\\HtmlElements\\Fixture\\Elements\\TypifiedElementChild';
		}
